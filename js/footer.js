        ...
        <footer>
                ...
                <div class="col-12 col-lg-3 col-md-5 col-sm-12 footer-col-4">
                  <div class="widget widget_gallery gallery-grid-4">
                    ...
                    <ul class="magnific-image">
                      <li><a class="magnific-anchor"><img src="assets/one.jpg" alt="Accessibility Translator Gallery" /></a></li>
                      <li><a class="magnific-anchor"><img src="assets/two.jpg" alt="Accessibility Translator Gallery" /></a></li>
                      <li><a class="magnific-anchor"><img src="assets/three.jpg" alt="Accessibility Translator Gallery" /></a></li>
                      <li><a class="magnific-anchor"><img src="assets/four.jpg" alt="Accessibility Translator Gallery" /></a></li>
                      <li><a class="magnific-anchor"><img src="assets/six.jpg" alt="Accessibility Translator Gallery" /></a></li>
                      <li><a class="magnific-anchor"><img src="assets/seven.jpg" alt="Accessibility Translator Gallery" /></a></li>
                      <li><a class="magnific-anchor"><img src="assets/nine.jpg" alt="Accessibility Translator Gallery" /></a></li>
                      <li><a class="magnific-anchor"><img src="assets/ten.jpg" alt="Accessibility Translator Gallery" /></a></li>
                    </ul>
                  </div>
                </div>
              </div>
          ...
          <div class="footer-bottom">
            <div class="container">
              <div class="row">
                <div class="col-md-3">
                  <div class="footer-site-info">2025 © <a href="#" target="_blank">Ngamfon Darlington</a></div>
                </div>
                <div class="col-md-6">
